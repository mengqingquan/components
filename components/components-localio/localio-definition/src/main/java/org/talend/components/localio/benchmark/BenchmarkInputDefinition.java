 ...
 */
public class BenchmarkInputDefinition extends AbstractComponentDefinition {

    public static final String NAME = "BenchmarkInput";

    public static final String RUNTIME = "org.talend.components.localio.runtime.benchmark.BenchmarkInputRuntime";

    public BenchmarkInputDefinition() {
        super(NAME, ExecutionEngine.BEAM);
    }

    @Override
    public Class<BenchmarkInputProperties> getPropertyClass() {
        return BenchmarkInputProperties.class;
    }
